...
const ADMIN_ACCESS_KEY = 'RAISE@College2026';
...
export default function Login() {
  ...
  const handleKeySubmit = (e) => {
    ...
    if (accessKey === ADMIN_ACCESS_KEY) {
      ...
      setKeyError('Invalid access key. Contact your administrator.');
    }
  };
          ...
          {step === 'key' && (
            <>
              <div style={{ textAlign: 'center', marginBottom: '28px' }}>
                <div style={{ width: '56px', height: '56px', background: '#EEF0FF', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
                  <ShieldCheck size={28} color="#3D3BF3" />
                </div>
              ...
              <form onSubmit={handleKeySubmit}>
                ...
                <button type="submit"
                  style={{ width: '100%', padding: '13px', background: '#3D3BF3', color: '#fff', border: 'none', borderRadius: '12px', fontSize: '15px', fontWeight: '700', cursor: 'pointer' }}>
                  Continue
                </button>
              </form>
